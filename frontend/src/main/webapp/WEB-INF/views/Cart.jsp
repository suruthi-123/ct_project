...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"> <height="77" width="77" style="font-family: monotype corsiva;" /><b>fashionjwellery</b></h1>
	</center>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/frontend/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/frontend/usercart/cart/addItem/'+id).success(function (data) {
